...
public class FavWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.example.submission1dicoding.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.submission1dicoding.EXTRA_ITEM";
